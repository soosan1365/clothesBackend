    ...
    <form onSubmit={onSubmitHandler}>
      ...
      <div className='flex flex-col  sm:flex-row gap-2 w-full sm:gap-8'>
        ...
        <div>
          ...
          <input onChange={(e) => setPrice(e.target.value)} value={price} type="number" placeholder='25 ' required className='w-full max-w-[120px] px-3 py-2' />
        </div>
      </div>
      <div>
      ...
      <button type='submit' className='w-28 py-3 mt-4 hover:bg-pink-200 hover:text-black bg-black text-white rounded-md'>ADD</button>
    </form>
  )
}
